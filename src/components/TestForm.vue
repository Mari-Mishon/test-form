<template>
  <div class="container">
    <h3 v-if="alert">Новый клиент успешно создан</h3>
    <form @submit.prevent="sendForm()" class="testForm" v-if="finishForm">
      <h1>Новый клиент:</h1>
      <p class="note">
      ...
      <div class="tab" v-show="currentTab === 1">
        ...
        <div class="field">
          <p>
            <label for="birth-date" class="form_label_marked"
              >Дата рождения</label
            >
            <input
              id="birth-date"
        ...
        <div class="field">
          <p>
            <label for="attending_doctor" class="form_label"
              >Лечащий врач</label
            >
            <select
      ...
      <div class="tab" v-show="currentTab === 2">
        ...
        <div class="field">
          <p>
            <label for="index" class="form_label">Индекс</label>
            <input
              id="index"
              type="text"
              v-model="pochtaIndex"
        ...
        <div class="field">
          <p>
            <label for="country" class="form_label">Страна</label>
            <input
              id="country"
              type="text"
              v-model="country"
        ...
        <div class="field">
          <p>
            <label for="area" class="form_label">Область</label>
            <input
              id="area"
              type="text"
              v-model="area"
        ...
        <div class="field">
          <p>
            <label for="city" class="form_label_marked">Город</label>
            <input
              id="city"
              type="text"
              v-model="city"
        ...
        <div class="field">
          <p>
            <label for="street" class="form_label">Улица</label>
        ...
        <div class="field">
          <p>
            <label for="house" class="form_label">Дом</label>
      ...
      <div class="tab" v-show="currentTab === 3">
        <p class="header">Документ:</p>
        <div class="field">
          <p>
            <label for="document_type" class="form_label_marked"
              >Тип документа</label
            >
            <select
              name="document_type"
        ...
        <div class="field">
          <p>
            <label for="passport_serail" class="form_label">Серия</label>
            <input
              id="passport_serial"
              type="text"
        ...
        <div class="field">
          <p>
            <label for="passport_number" class="form_label">Номер</label>
            <input
              id="passport_number"
              type="text"
        ...
        <div class="field">
          <p>
            <label for="passport-auhority" class="form_label">Кем выдан</label>
            <input
        ...
        <div class="field">
          <p>
            <label for="passport-date" class="form_label_marked"
              >Дата выдачи</label
            >
            <input
              id="pasport-date"
